...
const navigation = [
  ...
  {
    title: 'Contributing',
    links: [{ title: 'Coding standards', href: '/docs/coding-standards' }],
  },
]
    ...
    <>
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="sticky top-[4.5rem] -ml-0.5 overflow-y-auto py-16 pl-0.5">
        ...
        <div className="hidden xl:sticky xl:top-[4.5rem] xl:-mr-6 xl:block xl:flex-none xl:overflow-y-auto xl:py-16 xl:pr-6">
